function solveClasses() {
    ...
    class Pet {
        ...
        toString() {
            ...
            if (this.comments.length > 0) output.push(`Special requirements: ${this.comments.join(', ')}`);
    ...
    class Cat extends Pet {
        ...
        toString() {
            ...
            output.push('Main information:');

            if (this.scratching == true) output.push(`${this.name} is a cat with ${this.insideHabits}, but beware of scratches.`);
            else output.push(`${this.name}, is a cat with ${this.insideHabits}`);
    ...
    class Dog extends Pet {
        ...
        toString() {
            ...
            output.push('Main information:', `${this.name} is a dog with need of ${this.runningNeeds}km running every day and ${this.trainability} trainability.`);
